...
export const CowCard: FC<CowCardProps> = ({
    cowDetails }) => {
    const {
        age,
        grassPreference,
        ...
        <Card className="max-w-sm rounded-2xl shadow-lg hover:shadow-xl transition duration-300 flex flex-col">
            ...
            <CardContent className="flex flex-col gap-3 flex-grow">
                ...
                <div className="flex flex-col gap-1 text-sm">
                    <p><strong>🌿 Grass:</strong> {grassPreference}</p>
                    <p><strong>🍺 Beer:</strong> {favoriteBeer}</p>
                    <p><strong>📏 Height:</strong> {heightInMeters} m</p>
                    <p><strong>⚖️ Weight:</strong> {weightInKg} kg</p>
                </div>
                ...
                <div className="flex gap-2 mt-auto">
                    <Button
                        ...
                        color="success"
                        fullWidth
                        onClick={() => console.log("Buy cow", cowDetails)}
                    >
                        Buy
                    </Button>
                    ...
                    <Button
                        ...
                        color="primary"
                        fullWidth
                        onClick={() => console.log("Rent cow", cowDetails)}
                    >
                        Rent
                    </Button>
                </div>
